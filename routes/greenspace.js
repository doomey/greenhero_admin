...
router.get('/', function(req, res, next) {
   ...
   function selectGreenspace(total, connection, callback) {
      ...
      var select = "select e.id as eid, i.nickname as nickname, e.title as title, e.heart as heart, date_format(CONVERT_TZ(e.wdatetime,'+00:00','+9:00'),'%Y-%m-%d %H:%i:%s') as wdatetime "+
